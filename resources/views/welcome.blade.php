    ...
    <div id="app">
        ...
        <header class="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-200">
            <nav class="container mx-auto px-6 py-2 flex justify-between items-center">
                ...
                @if (!auth()->user())
                    <a href="/supplier/register" class="hidden md:inline-block bg-pink-600 text-white font-semibold px-5 py-2 rounded-lg hover:bg-pink-700 transition-colors duration-300">
                        Sign up
                    </a>
                @else
                    <a href="/supplier" class="hidden md:inline-block bg-pink-600 text-white font-semibold px-5 py-2 rounded-lg hover:bg-pink-700 transition-colors duration-300">
                        Go to Dashboard
                    </a>
                @endif
        ...
        <main>
            ...
            <section class="bg-white">
                <div class="container mx-auto px-6 py-20 text-center">
                    ...
                    <a href="#eligibility-form" class="mt-8 inline-block bg-pink-600 text-white font-bold px-8 py-4 rounded-lg text-lg hover:bg-pink-700 transition-transform duration-300 hover:scale-105">
            ...
            <section id="eligibility-form" class="py-20">
                <div class="container mx-auto px-6">
                    <div class="text-center mb-12">
                        ...
                        <p class="mt-2 text-md text-slate-500">Get verified in four easy steps.</p>
                    </div>
                    <div class="grid md:grid-cols-4 gap-10 text-center">
                        <div class="bg-white p-8 rounded-xl shadow-sm">
                            <div class="bg-pink-100 text-pink-600 rounded-full h-16 w-16 flex items-center justify-center mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                                </svg>
                            </div>
                            <h3 class="text-xl font-semibold mt-6">1. Create an Account</h3>
                            <p class="mt-2 text-slate-600">Click the sign-up button to create your supplier account and fill out the initial details.</p>
                        </div>
                        <div class="bg-white p-8 rounded-xl shadow-sm">
                            <div class="bg-pink-100 text-pink-600 rounded-full h-16 w-16 flex items-center justify-center mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <h3 class="text-xl font-semibold mt-6">2. Submit Your Details</h3>
                            <p class="mt-2 text-slate-600">Fill out our eligibility and profiling form with accurate information about your business.</p>
                        </div>
                        <div class="bg-white p-8 rounded-xl shadow-sm">
                            <div class="bg-pink-100 text-pink-600 rounded-full h-16 w-16 flex items-center justify-center mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <h3 class="text-xl font-semibold mt-6">3. Verification</h3>
                        ...
                        <div class="bg-white p-8 rounded-xl shadow-sm">
                            ...
                            <h3 class="text-xl font-semibold mt-6">4. Get Approved</h3>
