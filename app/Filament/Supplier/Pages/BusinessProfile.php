...
class BusinessProfile extends Page
{
    ...
    // public function documentSchema(): array
    // {
    //     return [
    //         Section::make('Document Uploads')
    //             ->description('Please upload the necessary documents to verify your business identity and eligibility.')
    //             ->icon(Heroicon::DocumentText)
    //             ->schema([
    //                 FileUpload::make('business_permit')
    //                     ->disk('public')
    ...
    //                             ->prepend((string) now()->format('YmdHis') . '_')
    //                     )
    //                     ->directory('business_documents')
    //                     ->maxSize(5120)
    //                     ->moveFiles()
    //                     ->required()
    //                     ->helperText('Upload a valid business permit issued by the local government. Maximum file size: 5MB.'),
    //                 FileUpload::make('tax_identification_number')
    //                     ->disk('public')
    ...
    //                     ->moveFiles()
    //                     ->required()
    //                     ->helperText('Upload your Tax Identification Number document. Maximum file size: 5MB.'),
    //             ]),
    //     ];
    // }
}
